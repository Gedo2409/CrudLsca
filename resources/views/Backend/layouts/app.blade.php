    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('backend.index') }}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Dashboard</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('colaboradores.index') }}" aria-expanded="false"><i class=" fas fa-address-book"></i><span
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
               Hecho por los talentosisimos y guapos 
               <ul>
                  <center><li>1nombre</li></center>
                 <center><li>Segundo nombre</li></center>
               </ul>
